...
- **Tích hợp nhiều dịch vụ email**: Tích hợp sẵn, bên thứ 3, Worker Email tự triển khai và nhiều giải pháp khác
...
| CF Worker | `cfworker` | Tự xây dựng email qua Cloudflare Worker |
